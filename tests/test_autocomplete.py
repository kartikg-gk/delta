...
from delta_app.tui.autocomplete import (
    CompletionItem,
    CompletionOption,
    CompletionProvider,
    CompletionState,
...
from delta_app.commands import CommandRegistry, SlashCommand, build_default_registry
...
def _handler(ctx: object) -> object:
    from delta_app.commands import CommandResult
