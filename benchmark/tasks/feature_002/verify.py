"""Verifier for feature_002.

Method: verify.py runs tests using a stub transport that counts attempts; the whole suite must finish in under 5 seconds, so a real sleep fails the task.
