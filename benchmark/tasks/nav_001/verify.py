"""Verifier for nav_001.

Method: Rubric-graded: the written trace must name the correct entry point, middleware chain, handler, and persistence call, checked against a reference answer.
