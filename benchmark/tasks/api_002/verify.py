"""Verifier for api_002.

Method: verify.py asserts the old package is absent from both imports and the dependency manifest, and that the integration suite passes against a stub of the new API.
