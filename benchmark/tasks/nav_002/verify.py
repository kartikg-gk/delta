"""Verifier for nav_002.

Method: verify.py compares the produced inventory against a known ground- truth list of call sites, scoring recall and precision; the aliased and dynamic sites must both appear.
