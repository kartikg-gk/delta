"""Verifier for debug_003.

Method: verify.py exports a fixture dataset containing unicode, embedded delimiters, and nulls, re-imports it, and asserts an exact round-trip.
