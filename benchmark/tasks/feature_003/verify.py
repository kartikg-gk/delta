"""Verifier for feature_003.

Method: verify.py runs a conformance suite written directly from the design note, including TTL expiry, LRU eviction order, and explicit invalidation.
