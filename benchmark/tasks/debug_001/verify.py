"""Verifier for debug_001.

Method: verify.py runs the test 50 times in randomised order and asserts 50 passes, and greps the diff for added sleeps or retry decorators.
