"""Verifier for feature_001.

Method: verify.py shells out to the CLI twice — with and without the flag — asserts the JSON parses and the default output is unchanged byte-for-byte.
