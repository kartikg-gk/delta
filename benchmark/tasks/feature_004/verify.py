"""Verifier for feature_004.

Method: verify.py runs the suite plus a schema check asserting the new routes follow the same error envelope and pagination contract as the existing ones.
