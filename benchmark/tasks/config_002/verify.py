"""Verifier for config_002.

Method: verify.py exercises every layer combination and asserts the documented precedence, including unset-vs-empty and boolean coercion of values like '0' and 'false'.
