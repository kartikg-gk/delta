"""Verifier for feature_005.

Method: verify.py captures log output during a simulated request and asserts every line is valid JSON carrying the same request id, including lines emitted from deep helper modules.
