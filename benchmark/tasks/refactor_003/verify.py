"""Verifier for refactor_003.

Method: verify.py asserts correctness plus concurrency: fetching N stubbed resources each with a 100ms delay must complete in well under N*100ms.
