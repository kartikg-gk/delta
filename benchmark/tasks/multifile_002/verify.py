"""Verifier for multifile_002.

Method: verify.py posts a record through the public API with the new field set, reads it back, and asserts round-trip fidelity end to end.
