"""Verifier for terminal_001.

Method: verify.py runs the documented build command in a clean checkout and asserts exit code 0 plus the presence of the expected artifacts.
