"""Verifier for multifile_001.

Method: verify.py asserts the suite passes, that the old identifier is gone from source, and that the on-disk JSON fixtures still contain the original serialised key names.
